...
export const getTitleAchievement = (
  ...
  return api({
    ...
    .then((res) => {
      console.log('getTitleAchievement response data');
      console.log(res);
      console.log(res.data);
      return res;
    })
    .catch((err) => {
      console.log('getTitleAchievement Error');
      console.log(err);
    });
};
...
export const getTitleMain = (titleId: number) => {
  return api({
    ...
    .then((res) => {
      console.log('getTitleMain response data');
      console.log(res);
      console.log(res.data);
      return res;
    })
    .catch((err) => {
      console.log('getTitleMain Error');
      console.log(err);
    });
};
